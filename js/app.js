...
//These are needed storing the input links in a Google Sheet
const CONFIG = {
...
// Store the most recent submission for fallback display -- this is needed because Google Sheets crashes sometime. It displays something while it's unavailable.
...
//It gets the data from Google Sheets CSV
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (input) {
    ...
    // Keep focus constantly on input for kiosk
    input.focus();
